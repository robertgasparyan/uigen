    ...
    return (
      <div className="flex items-center justify-center h-full px-4">
        <div className="flex items-center gap-4">
          <div className="flex items-center justify-center w-14 h-14 rounded-2xl bg-blue-50 shadow-sm flex-shrink-0">
            <Bot className="h-7 w-7 text-blue-800" />
          </div>
          <div>
            <p className="text-neutral-900 font-semibold text-lg">Start a conversation to generate React components</p>
